const Page4 = require('../model/Page4')
...
exports.createBilenmisTakim = async (req, res) => {
    try {
        ...
        const takim = new Page4(req.body);
...
exports.getBilenmisTakim = async (req, res) => {
    try {
        ...
        const result = await Page4.findById(id)
        res.json({
            success: true,
            result
        })
...
exports.deleteBilenmisTakim = async (req, res) => {
    try {
        ...
        const result = await Page4.findByIdAndRemove(id)
        res.json({
            success: true,
            result
        })
...
exports.updateBilenmisTakim = async (req, res) => {
    try {
        ...
        const result = await Page4.findByIdAndUpdate(req.params.id, updateData);
        res.json({
            result
        })
