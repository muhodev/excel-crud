const RTakim = require('../model/RTakim')
exports.getBilenmisTakimListesi = async (req, res) => {
    ...
    //     console.log(yachtType,"type backend");
        const result = await RTakim.find({});
        res.json({
            success: true,
            result
        })
...
exports.createBilenmisTakim = async (req, res) => {
    try {
        ...
        const takim = new RTakim(req.body);
...
exports.getBilenmisTakim = async (req, res) => {
    try {
        ...
        const result = await RTakim.findById(id)
        res.json({
            success: true,
            result
        })
...
exports.deleteBilenmisTakim = async (req, res) => {
    try {
        ...
        const result = await RTakim.findByIdAndRemove(id)
        res.json({
            success: true,
            result
        })
...
exports.updateBilenmisTakim = async (req, res) => {
    try {
        ...
        const result = await RTakim.findByIdAndUpdate(req.params.id, updateData);
        res.json({
            result
        })
