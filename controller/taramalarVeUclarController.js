const TaramalarVeUclar = require('../model/TaramalarVeUclar')
exports.getBilenmisTakimListesi = async (req, res) => {
    ...
    //     console.log(yachtType,"type backend");
        const result = await TaramalarVeUclar.find({});
        res.json({
            success: true,
            result
        })
...
exports.createBilenmisTakim = async (req, res) => {
    try {
        ...
        const takim = new TaramalarVeUclar(req.body);
...
exports.getBilenmisTakim = async (req, res) => {
    try {
        ...
        const result = await TaramalarVeUclar.findById(id)
        res.json({
            success: true,
            result
        })
...
exports.deleteBilenmisTakim = async (req, res) => {
    try {
        ...
        const result = await TaramalarVeUclar.findByIdAndRemove(id)
        res.json({
            success: true,
            result
        })
...
exports.updateBilenmisTakim = async (req, res) => {
    try {
        ...
        const result = await TaramalarVeUclar.findByIdAndUpdate(req.params.id, updateData);
        res.json({
            result
        })
