const TCakiTakim = require('../model/TCakiTakim')
exports.getBilenmisTakimListesi = async (req, res) => {
    ...
    //     console.log(yachtType,"type backend");
        const result = await TCakiTakim.find({});
        res.json({
            success: true,
            result
        })
...
exports.createBilenmisTakim = async (req, res) => {
    try {
        ...
        const takim = new TCakiTakim(req.body);
...
exports.getBilenmisTakim = async (req, res) => {
    try {
        ...
        const result = await TCakiTakim.findById(id)
        res.json({
            success: true,
            result
        })
...
exports.deleteBilenmisTakim = async (req, res) => {
    try {
        ...
        const result = await TCakiTakim.findByIdAndRemove(id)
        res.json({
            success: true,
            result
        })
...
exports.updateBilenmisTakim = async (req, res) => {
    try {
        ...
        const result = await TCakiTakim.findByIdAndUpdate(req.params.id, updateData);
        res.json({
            result
        })
