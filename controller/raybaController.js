const Rayba = require('../model/Rayba')
...
exports.createBilenmisTakim = async (req, res) => {
    try {
        ...
        const takim = new Rayba(req.body);
...
exports.getBilenmisTakim = async (req, res) => {
    try {
        ...
        const result = await Rayba.findById(id)
        res.json({
            success: true,
            result
        })
...
exports.deleteBilenmisTakim = async (req, res) => {
    try {
        ...
        const result = await Rayba.findByIdAndRemove(id)
        res.json({
            success: true,
            result
        })
...
exports.updateBilenmisTakim = async (req, res) => {
    try {
        ...
        const result = await Rayba.findByIdAndUpdate(req.params.id, updateData);
        res.json({
            result
        })
